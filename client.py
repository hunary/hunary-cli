...
def api_call(url, method='get', files=None, data=None,
...
upload_parser.add_argument(
    "-f", "--file", dest="upload_file",
    help='/path/to/file for upload/parsing'
                        )
upload_parser.add_argument(
    "-n", "--name", dest="doc_name",
    help='endpoint you want created ( docs upload --file /file -n rome)'
)
upload_parser.add_argument(
    "-t", "--type", dest="file_type",
...
search_parser.add_argument(
    "doc_name",
    help="Name of doc database you want deleted"
)
